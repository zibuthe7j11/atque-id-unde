...
[![CI](https://github.com/zibuthe7j11/atque-id-unde/workflows/CI/badge.svg)](https://github.com/zibuthe7j11/atque-id-unde/actions/workflows/ci.yml)
[![NPM version](https://img.shields.io/npm/v/@zibuthe7j11/atque-id-unde.svg?style=flat)](https://www.npmjs.com/package/@zibuthe7j11/atque-id-unde)
...
resources that demonstrate the use of @zibuthe7j11/atque-id-unde in different use-cases and scenarios:

* A reference application using [Fastify with @zibuthe7j11/atque-id-unde and dotenv](https://github.com/lirantal/fastify-dotenv-envschema-example)
